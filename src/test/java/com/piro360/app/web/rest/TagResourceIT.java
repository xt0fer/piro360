...
class TagResourceIT {
    ...
    public static Tag createEntity(EntityManager em) {
        Tag tag = new Tag().contents(DEFAULT_CONTENTS).location(DEFAULT_LOCATION).commentDate(DEFAULT_COMMENT_DATE);
        return tag;
    }
    ...
    public static Tag createUpdatedEntity(EntityManager em) {
        Tag tag = new Tag().contents(UPDATED_CONTENTS).location(UPDATED_LOCATION).commentDate(UPDATED_COMMENT_DATE);
        return tag;
    }
    ...
    void createTag() throws Exception {
        ...
        assertThat(testTag.getContents()).isEqualTo(DEFAULT_CONTENTS);
        assertThat(testTag.getLocation()).isEqualTo(DEFAULT_LOCATION);
        assertThat(testTag.getCommentDate()).isEqualTo(DEFAULT_COMMENT_DATE);
    }
    ...
    void putNewTag() throws Exception {
        ...
        updatedTag.contents(UPDATED_CONTENTS).location(UPDATED_LOCATION).commentDate(UPDATED_COMMENT_DATE);
        ...
        Tag testTag = tagList.get(tagList.size() - 1);
        assertThat(testTag.getContents()).isEqualTo(UPDATED_CONTENTS);
        assertThat(testTag.getLocation()).isEqualTo(UPDATED_LOCATION);
        assertThat(testTag.getCommentDate()).isEqualTo(UPDATED_COMMENT_DATE);
    }
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.contents(UPDATED_CONTENTS).commentDate(UPDATED_COMMENT_DATE);
    ...
    void fullUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.contents(UPDATED_CONTENTS).location(UPDATED_LOCATION).commentDate(UPDATED_COMMENT_DATE);
