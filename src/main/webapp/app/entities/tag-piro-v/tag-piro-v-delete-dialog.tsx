...
import { getEntity, deleteEntity } from './tag-piro-v.reducer';

export const TagPiroVDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="piro360App.tag.delete.question">
        <Translate contentKey="piro360App.tag.delete.question" interpolate={{ id: tagEntity.id }}>
...
export default TagPiroVDeleteDialog;
