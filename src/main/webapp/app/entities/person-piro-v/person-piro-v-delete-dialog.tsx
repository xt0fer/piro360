...
import { getEntity, deleteEntity } from './person-piro-v.reducer';

export const PersonPiroVDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="piro360App.person.delete.question">
        <Translate contentKey="piro360App.person.delete.question" interpolate={{ id: personEntity.id }}>
...
export default PersonPiroVDeleteDialog;
