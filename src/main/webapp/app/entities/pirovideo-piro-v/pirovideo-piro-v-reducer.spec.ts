...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PIROVIDEO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PIROVIDEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PIROVIDEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PIROVIDEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PIROVIDEO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PIROVIDEO actions', async () => {
      const expectedActions = [
        {
